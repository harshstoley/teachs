    ...
    <form onSubmit={submit}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: compact ? '1fr' : '1fr 1fr', gap: 16 }}>
        <div className="form-group" style={{ margin: 0 }}>
          ...
          <input name="name" value={form.name} onChange={handle} placeholder="Parent / Student name" className="form-input dark" required />
        </div>
        <div className="form-group" style={{ margin: 0 }}>
          <label className="form-label">Phone Number *</label>
          <input name="phone" value={form.phone} onChange={handle} placeholder="+91 XXXXX XXXXX" className="form-input dark" required />
        </div>
        <div className="form-group" style={{ margin: 0 }}>
          <label className="form-label">Email (Optional)</label>
          <input name="email" type="email" value={form.email} onChange={handle} placeholder="your@email.com" className="form-input dark" />
        </div>
        <div className="form-group" style={{ margin: 0 }}>
          <label className="form-label">Student's Class</label>
          <select name="student_class" value={form.student_class} onChange={handle} className="form-input dark">
      ...
      <div className="form-group" style={{ marginTop: 16 }}>
        ...
        <input name="subject" value={form.subject} onChange={handle} placeholder="e.g. Math + Science, English + SST" className="form-input dark" />
      </div>

      {!compact && (
        <div className="form-group">
          <label className="form-label">Any specific concerns? (Optional)</label>
          <textarea name="message" value={form.message} onChange={handle} placeholder="Tell us about your child's learning needs..." className="form-input dark" rows={3} />
        </div>
      )}
